...
create index tmpidxcmp on tmpcmp (nmComp,cdrubricaagrupamento,CDPESSOA, cdvinculo);
create index tmpidx2cmp on tmpcmp  (nmComp,cdvinculo);
create index tmpidx3cmp on tmpcmp  (nmComp,CDPESSOA);
