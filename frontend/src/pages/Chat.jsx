  ...
  return (
    <div className="flex h-[calc(100vh-2rem)] gap-4">
      ...
      <div className="flex-1 flex flex-col h-full relative">
        ...
        <div className="grow flex flex-col rounded-xl bg-slate-950/50 overflow-hidden shadow-2xl border border-slate-800">
          {/* Messages Area */}
          <div className="grow overflow-y-auto p-6 space-y-6 no-scrollbar">
          ...
          <div className="p-4 bg-slate-900/80 border-t border-slate-800">
            ...
            <div className="flex gap-2">
              ...
              <input
                ...
                className="grow bg-purple-600/5 text-white placeholder-slate-400 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500/50 border border-purple-500/20"
